    ...
    <div class="blog-section pt-100 pb-70 bg-black">
        <div class="container">
            <div class="row">
               ...
               <?php
					$in= $con->query("select * from fixthali");
                        ...
                        <div class="product-card product-card-dark">
                            <div class="product-card-thumb">
                                <div class="product-card-thumb-inner">
                                    <img class="jaydipi" style="border-radius:5px; max-height:290px; background-color:red;"  src="<?php echo $row[2]; ?>">

                                        <div class="product-card-button">
                                            <form action="" method="POST" name="addcart">
                                                    <a href="thali-details.php?id=<?php echo $row[0];?>" class="btn">More</a>
                                            </form>
                                        </div>
                                </div>
                            </div>
                            <div class="product-card-content">
                                <h3><a href="shop-details.html"><?php echo $row[1];?></a></h3>
                                    <h4 class="product-price">₹ <?php echo $row[3];?></h4>
                            </div>
                        </div>
                    </div>

    ...
    <section class="cart-section pt-100 pb-70 bg-black">
        <div class="container">
            <div class="cart-table cart-table-dark">
                <table>
                    <?php
                        $in = $con->query("select * from carthistory where userid='$_SESSION[userid]'");
                    ...
                    <tbody>
                       ...
                       if($r[0]!="")
                       {
                                 ...
                                 $dish1=$con->query("select SUM(amount) from carthistory where userid='$_SESSION[userid]'");
                                 $rqj=mysqli_fetch_array($dish1);
